...
path = "C:/Users/sathish sp/Desktop/Finished/save_images2/"
...
for file_list in dir_list:
    print(file_list)
    # For webcam input:
    image = cv2.imread("C:/Users/sathish sp/Desktop/Finished/save_images2/"+file_list)
    ...
    with mp_pose.Pose(
      ...
      df.loc[count, 'RIGHT_WRIST'] = str({'x':right_wrist_x,'y':right_wrist_y,'z':right_wrist_z,'v':right_wrist_visibility})
      ...
      df.loc[count, 'LEFT_WRIST'] = str({'x':left_wrist_x,'y':left_wrist_y,'z':left_wrist_z,'v':left_wrist_visibility})
      ...
      df.loc[count, 'NOSE'] = str({'x':nose_x,'y':nose_y,'z':nose_z,'v':nose_visibility})      
      ...
      df.loc[count, 'LEFT_EYE'] = str({'x':left_eye_x,'y':left_eye_y,'z':left_eye_z,'v':left_eye_visibility})
      ...
      df.loc[count, 'RIGHT_EYE'] = str({'x':right_eye_x,'y':right_eye_y,'z':right_eye_z,'v':right_eye_visibility})
      ...
      df.loc[count, 'LEFT_EAR'] = str({'x':left_ear_x,'y':left_ear_y,'z':left_ear_z,'v':left_ear_visibility})
      ...
      df.loc[count, 'RIGHT_EAR'] = str({'x':right_ear_x,'y':right_ear_y,'z':right_ear_z,'v':right_ear_visibility})
      ...
      df.loc[count, 'LEFT_SHOULDER'] = str({'x':left_shoulder_x,'y':left_shoulder_y,'z':left_shoulder_z,'v':left_shoulder_visibility})
      ...
      df.loc[count, 'RIGHT_SHOULDER'] = str({'x':right_shoulder_x,'y':right_shoulder_y,'z':right_shoulder_z,'v':right_shoulder_visibility})
      ...
      df.loc[count, 'LEFT_KNEE'] = str({'x':left_knee_x,'y':left_knee_y,'z':left_knee_z,'v':left_knee_visibility})
      ...
      df.loc[count, 'RIGHT_KNEE'] = str({'x':right_knee_x,'y':right_knee_y,'z':right_knee_z,'v':right_knee_visibility})
      ...
      df.loc[count, 'LEFT_ELBOW'] = str({'x':left_elbow_x,'y':left_elbow_y,'z':left_elbow_z,'v':left_elbow_visibility})
      ...
      df.loc[count, 'RIGHT_ELBOW'] = str({'x':right_elbow_x,'y':right_elbow_y,'z':right_elbow_z,'v':right_elbow_visibility})
      ...
      df.loc[count, 'RIGHT_HIP'] = str({'x':right_hip_x,'y':right_hip_y,'z':right_hip_z,'v':right_hip_visibility})
      ...
      df.loc[count, 'LEFT_HIP'] = str({'x':left_hip_x,'y':left_hip_y,'z':left_hip_z,'v':left_hip_visibility})
      ...
      df.loc[count, 'RIGHT_ANKLE'] = str({'x':right_ankle_x,'y':right_ankle_y,'z':right_ankle_z,'v':right_ankle_visibility})
      ...
      df.loc[count, 'LEFT_ANKLE'] = str({'x':left_ankle_x,'y':left_ankle_y,'z':left_ankle_z,'v':left_ankle_visibility})
